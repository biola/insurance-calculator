module Admin
  class ChildCoveragesController < Admin::ApplicationController
    before_action :set_child_coverage, only: %i[show edit update destroy]
    ...
    def create
      ...
      if @child_coverage.save
        redirect_to [:admin, @child_coverage],
                    notice: 'Child coverage was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      if @child_coverage.update(child_coverage_params)
        redirect_to [:admin, @child_coverage],
                    notice: 'Child coverage was successfully updated.'
      else
        render :edit
      end
    end
    ...
    def destroy
      ...
      redirect_to admin_child_coverages_url,
                  notice: 'Child coverage was successfully destroyed.'
    end
