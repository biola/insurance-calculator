module Admin
  class CoveragesController < Admin::ApplicationController
    ...
    def create
      ...
      if @coverage.save
        redirect_to [:admin, @coverage],
                    notice: 'Coverage was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      if @coverage.update(coverage_params)
        redirect_to [:admin, @coverage],
                    notice: 'Coverage was successfully updated.'
      else
        render :edit
      end
    end
    ...
    def destroy
      ...
      redirect_to admin_coverages_url,
                  notice: 'Coverage was successfully destroyed.'
    end
